            ...
            <ScrollView>
                <View style={{ backgroundColor: 'white' }}>
                    <View style={styles.avatarView}>
                        ...
                        />
                        <Text style={{ color: 'black', fontSize: 20, marginTop: 15, fontWeight: 'bold' }}>
                ...
                <View style={{ backgroundColor: 'white', width: "100%", height: '45%', marginTop: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                        <Text style={{ color: 'black', fontSize: 17, fontWeight: 'bold', marginLeft: 20, marginTop: 10 }}>Thông tin cá nhân</Text>
                        <TouchableOpacity>
                            <Text style={{ color: 'red', fontWeight: 'bold', fontSize: 16, marginRight: 20, marginTop: 10 }}>Sửa</Text>
                        </TouchableOpacity>
                    </View>
                    <View>
                    ...
                    <View>
                        <View style={styles.viewInfo}>
                            ...
                            <View style={{ justifyContent: 'center', marginEnd: 5, marginLeft: 10 }}>
                                ...
                                <Text style={{ color: 'black', marginTop: 5 }}>0987****12</Text>
                            </View>
                        </View>
                    </View>
                    <View>
                ...
                <View style={styles.address}>
                    <View style={{ flexDirection: 'row', justifyContent: "space-between", marginTop: 10 }}>
                        <Text style={{ color: 'black', marginLeft: 15, marginTop: 5, fontSize: 16, fontWeight: "bold" }}>Sổ địa chỉ</Text>
                        <TouchableOpacity>

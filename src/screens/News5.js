...
export default function News5({ navigation }) {
   ...
   return (
      <View>
         ...
         <ScrollView>
            <View style={{ marginTop: 5, marginLeft: 10, marginRight: 10,height:4670 }}>
               <Text style={{ fontSize: 27, color: colors.text, fontWeight: "bold" }}>Bài báo cáo đặc biệt phần 1: Câu chuyện của Bs Steve Kopecky</Text>
               <Text style={{
                  marginTop: 7,
                  fontSize: 17,
                  color: colors.text
               }}>Câu chuyện dưới đây được kể bởi Steve Kopecky - một vị bác sĩ tim mạch - về chính cuộc đời của mình. Nhờ những trải nghiệm “không mấy vui” trong cuộc đời mình, ông đã tích lũy được những bài học cho chính bản thân để có một sức khỏe tốt và sống cuộc sống ý nghĩa hơn.</Text>
               <Image
               ...
               <Text style={{
                  ...
                  fontSize: 17,
                  color: colors.text,
               }}>Đột tử. Các chức năng vật lý vẫn bình thường cho đến khi xảy ra đột tử. Tình trạng này có thể xảy ra khi tuổi đời còn rất trẻ, ví dụ như tai nạn, hoặc cái chết do tình trạng loạn nhịp tim.</Text>
               <Icon
                  name="dot-single"
                  color={colors.text}
                  size={30}
               ...
               <Text style={{
                  ...
                  fontSize: 17,
                  color: colors.text,
               }}>Bệnh nan y. Các chức năng vật lý vẫn bình thường cho đến khi phát bệnh, ví dụ như ung thư. Sức khỏe giảm sút trong những tháng cuối đời.</Text>
               <Icon
                  name="dot-single"
                  color={colors.text}
                  size={30}
               ...
               <Text style={{
                  ...
                  fontSize: 17,
                  color: colors.text,
               }}>Suy cơ quan. Chức năng vật lý dao động lên xuống trong nhiều năm trước khi chết do suy các cơ quan.</Text>
               <Icon
                  name="dot-single"
                  color={colors.text}
                  size={30}

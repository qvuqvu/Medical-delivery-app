...
export default function News2({ navigation }) {
  return (
    <View style={{ backgroundColor: 'white' }}>
      ...
      <ScrollView>
        <View style={{ height: 5730 }}>
          <View style={{ margintop: 10, marginLeft: 10, marginRight: 10 }}>
            <Text style={{ fontSize: 27, marginBottom: 20, color: colors.black, fontWeight: "bold" }}>Bài báo cáo đặc biệt phần 3: 6 bước để sống lành mạnh mỗi ngày</Text>
            ...
            <Image
              ...
              style={{ width: 370, resizeMode: 'contain', alignSelf: 'center', height: 230, }}
            />

  ...
  return (
    <View>
      ...
      <ScrollView style={{ marginLeft: 10, marginRight: 10 }}>
        <View style={{ margintop: 10,height:5800 }}>
          <Text style={{ fontSize: 27, color: colors.text, fontWeight: "bold" }}>Bài báo cáo đặc biệt phần 3: 6 bước để sống lành mạnh mỗi ngày</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Những lựa chọn hằng ngày mà chúng ta đưa ra có thể dẫn đến việc chúng ta có khả năng mắc các bệnh mãn tính và phải gánh chịu các căn bệnh theo thời gian, vì vậy những lựa chọn này cũng có thể là một con đường để chúng ta quay về với một sức khỏe tốt.</Text>
          <Image
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Bước 2: Vận động và trở nên “cân đối”</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Bước 3: Ưu tiên cho một giấc ngủ chất lượng</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Giấc ngủ mang lại cho cơ thể một thời gian nghỉ để hồi phục sau các hoạt động đã thực hiện trong ngày. Điều này cho phép các tế bào loại bỏ các chất thải, tiến hành sửa chữa và tạo ra các tế bào mới. Mất ngủ trong một thời gian dài đang lấy đi khả năng tự chữa trị của cơ thể bạn.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Bước 4: Giải quyết những căng thẳng</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Bước 5: Tránh thuốc lá và các chất độc hại khác</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Bước 6: Hãy cân nhắc về việc sử dụng các chất cồn</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            fontSize: 17,
            color: colors.text
          }}>Đây là những cảm xúc hết sức phổ biến. Nhưng khi nói về cha tôi, một bác sĩ qua đời ở tuổi 91 – hai tuần sau khi ông gặp bệnh nhân cuối cùng của mình – đã luôn nhắc nhở tôi rằng: “Hãy nghỉ hưu vì con muốn làm một điều gì đó, chứ không phải do những điều gì khác”.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 22,
            color: colors.text,
            fontWeight: "bold"
          }}>Những thói quen lành mạnh giúp tăng cường hệ miễn dịch</Text>
          <Text style={{
            marginTop: 10,
            fontSize: 18,
            color: colors.text,
            fontWeight: "bold"
          }}>Ăn uống lành mạnh</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Ăn nhiều trái cây và rau củ để cung cấp những chất chống oxy hóa và kháng viêm – hỗ trợ hệ thống miễn dịch chống lại việc nhiễm trùng.</Text>
          <Text style={{
            marginTop: 10,
            fontSize: 18,
            color: colors.text,
          ...
          <Text style={{
            ...
            fontSize: 17,
            color: colors.text
          }}>Những bài tập với cường độ vừa phải một cách thường xuyên sẽ làm tăng hoạt động tiêu diệt vi-rút của tế bào miễn dịch.</Text>
          <Text style={{
            marginTop: 10,
            fontSize: 18,
            color: colors.text,
            fontWeight: "bold"
          }}>Kiểm soát sự căng thẳng và tạo ra những sự liên kết trong xã hội</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Những hoạt động để làm cơ thể trở nên bình tĩnh cũng như các mối quan hệ hỗ trợ sẽ làm giảm căng thẳng, cắt giảm sự sản xuất cortisol và tăng cường chức năng miễn dịch.</Text>
          <Text style={{
            marginTop: 10,
            fontSize: 18,
            color: colors.text,
          ...
          <Text style={{
            ...
            fontSize: 17,
            color: colors.text
          }}>Một giấc ngủ chất lượng sẽ tăng cường số lượng các tế bào miễn dịch trong cơ thể và cải thiện tình trạng nhiễm trùng.</Text>
        </View>
      </ScrollView>
    </View>
  )

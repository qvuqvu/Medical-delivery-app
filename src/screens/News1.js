...
export default function News1({ navigation }) {
  return (
    <View style={{ backgroundColor: 'white' }}>
      ...
      <ScrollView>
        <View style={{ marginLeft: 10, marginRight: 10, height: 6350 }}>
          ...
          <View>
            ...
            <Image
              ...
              style={{ alignSelf: 'center', width: 380, height: 300, marginTop: 10 }}
            />
            ...
            <Text style={{ marginTop: 20, fontSize: 17, color: colors.black, fontWeight: '500' }}>Nguồn: cdc.gov</Text>
            <Text style={{ marginTop: 15, fontSize: 17, color: colors.black, fontWeight: '500' }}>Biên dịch: DS. Nguyễn Phạm Quỳnh Hoa</Text>
          </View>
        </View>
      </ScrollView>
    </View>

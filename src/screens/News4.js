...
export default function News4({ navigation }) {
  return (
    <View style={{ backgroundColor: 'white' }}>
      ...
      <ScrollView>
        <View style={{ marginLeft: 10, marginRight: 10,height:7100 }}>
          ...
          <Image
            ...
            style={{ width: 370, alignSelf: 'center', resizeMode: 'contain', height: 220, marginTop: 10 }}
          />
          ...
          <Image
            ...
            style={{ width: 300, alignSelf: 'center', height: 400 }}
          />

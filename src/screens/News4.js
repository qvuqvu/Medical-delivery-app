...
export default function News4({ navigation }) {
  ...
  return (
    <View>
      ...
      <ScrollView>
        <View style={{ marginTop: 5, marginLeft: 10, marginRight: 10,height:6800 }}>
          <Text style={{ fontSize: 27, color: colors.text, fontWeight: "bold" }}>Bài báo cáo đặc biệt phần 4: Làm thế nào để kiên trì với lối sống lành mạnh?</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Người Mỹ tốn rất nhiều tiền và mất nhiều thời gian để điều trị các bệnh mãn tính. Nhưng tại sao chúng ta không ngăn chặn bệnh tật ngay từ cánh cửa đầu tiên? Liệu điều đó có làm chúng ta có một cuộc sống tốt hơn và tiếp tục duy trì nó trong suốt cuộc đời mình?</Text>
          <Image
            source={{ uri: "https://www.medigoapp.com/uploads/Lam_the_nao_de_kien_tri_voi_loi_song_lanh_manh_de4160f6ac.jpg" }}
            style={{ width: 370, height: 200, resizeMode: "contain", marginTop: 10 }}
          />
          <Text style={{
            marginTop: 7,
            fontSize: 22,
            color: colors.text,
            fontWeight: "bold"
          }}>Sự thay đổi chậm rãi là sự thay đổi lâu dài</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            color: colors.text,
            fontWeight: "bold"
          }}>Thất bại đã dạy cho chúng ta những gì?</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Khi chúng ta muốn thay đổi, chúng ta thường nghĩ rằng: “Cứ làm đi, có gì phải lo”. Và nếu thật sự thất bại, vậy thì đã sao? Chỉ cần thử lại là được. Tuy nhiên bộ não thực tế không làm việc như cách chúng ta nghĩ. Và điều này có thể là một mối lo ngại.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Bằng cách nào điều này có thể xảy ra? Có một phần nhỏ của bộ não được gọi là habenula. Đây là trung tâm của não lưu trữ những dữ liệu về “phần thưởng tiêu cực” hoặc “sự thất bại”, được biết đến với vai trò trong việc hình thành các hành vi dựa trên những sự thất vọng trong quá khứ.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          ...
          <Text style={{
            ...
            fontSize: 17,
            color: colors.text
          }}>Nhóm tập luyện thể thao (AE) tham gia vào các bài tập ba lần một tuần. Bài tập bao gồm 10 phút khởi động, sau đó là 35 phút đi bộ liên tục hoặc đạp xe tại chỗ. Người tham gia được khuyến khích tuân theo chế độ ăn uống bình thường của họ.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Nhóm tập luyện thể thao kết hợp với DASH (AE + DASH) tham gia vào kế hoạch tập thể dục và tuân theo chế độ ăn DASH đã được nêu ở trên.</Text>
          <Text style={{
            marginTop: 7,
            fontSize: 17,
            color: colors.text
          }}>Các nhà nghiên cứu đánh giá các chức năng của những người tham gia trước và sau khi thử nghiệm. Và nhận thấy rằng việc tăng cường tập thể dục và chuyển sang chế độ ăn DASH đã thực sự cải thiện các chức năng trong cơ thể sau sáu tháng. Kết quả thể hiện trong hình dưới đây cho thấy hầu hết lợi ích đến từ việc kết hợp tập thể dục và thay đổi chế độ ăn uống. Khi so sánh với nhóm những người đã thay đổi chế độ ăn và thói quen tập luyện với những người duy trì thói quen hàng ngày của họ, bạn có thể thấy sự khác biệt được tạo ra lớn như thế này.</Text>

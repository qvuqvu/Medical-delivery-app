    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ marginLeft: 20, marginTop: 10 }}>
                            ...
                            <View style={{ width: 290, }}>
                                ...
                                >
                                    <View style={{ backgroundColor: colors.boxes, width: 270, height: 120, justifyContent: 'center', marginTop: 15, borderRadius: 15 }}>
                                        <Text style={{ alignSelf: 'center', color: colors.text, fontSize: 16, marginBottom: 10, marginRight: 74 }}>
                                            {item.nhathuoc}
                                        </Text>
                ...
                <Text style={{ color: colors.text, fontSize: 17, fontWeight: 'bold', }}>Nhà thuốc được ưu thích</Text>
                    ...
                    <View style={{ backgroundColor: colors.boxes, width: 270, height: 100, justifyContent: 'center', marginTop: 15, borderRadius: 15 }}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ marginLeft: 20 }}>
                                <Text style={{ color: colors.text, fontSize: 15 }}>{nhathuoc1[0].nhathuoc}</Text>
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "space-between" }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                        ...
                                        />
                                        <Text style={{ marginLeft: 5, color: colors.text }}>{nhathuoc1[0].averageReview}</Text>
                                    </View>
                                    <Text style={{ color: colors.text }}>~{nhathuoc1[0].farway}</Text>
                                </View>
                                <Text style={{ marginTop: 5, color: colors.text }}>Phản hồi: {<Text style={{ color: colors.text }}> Rất tích cực</Text>}</Text>
                            </View>
                        </View>
                    </View>
                </TouchableOpacity>
                ...
                <View>
                    ...
                    <Text style={{ color: colors.text, fontSize: 17, marginTop: 15, fontWeight: 'bold' }}>Bản tin Covid-19</Text>
                </View>
            </View>
        </SafeAreaView >
    )

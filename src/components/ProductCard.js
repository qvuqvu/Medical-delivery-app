        ...
        >
            <View style={[styles.cardView, { backgroundColor: colors.background }]}>
                <View style={[styles.imageView, { marginTop: 20 }, { width: screenWidth }]}>
                    ...
                    <View>
                        <Text style={[{ color: colors.money, textAlign: 'center', fontWeight: "bold", marginTop: 10 }]}>{Price}</Text>
                    </View>
                    <View style={{ flexDirection: "row", marginBottom: 15 }}>
                        ...
                        <TouchableOpacity style={{ borderWidth: 0.7, borderColor: colors.buttonx, borderRadius: 5, marginTop: 12, marginRight: 30, width: 50, height: 40, alignItems: "center", borderColor: colors.text }}>
                            <Icon1
                                onPress={() => {
                                    check()
                                }}
                                name='shoppingcart'
                                style={{ color: colors.buttonx, justifyContent: 'center' }}
                                size={35} >
                            </Icon1>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={{ borderWidth: 1.25, borderColor: colors.buttonx, borderRadius: 5, height: 40, width: 85, marginTop: 12, marginRight: 10, borderColor: colors.text }} >
                            <Text style={{ fontWeight: "bold", marginTop: 10, marginLeft: 6, color: colors.buttonx }}>MUA NGAY</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
